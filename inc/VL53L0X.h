...
// uint8_t... is not undefined in C51,   bool is not allowed in struct
...
struct VL53L0X
{
  //uint8_t last_status; // status of last I2C transmission, not need for 8051
  unsigned char io_2v8;   // C51 no bool type
  uint8_t addr;
  uint32_t io_timeout;
  unsigned char did_timeout;
